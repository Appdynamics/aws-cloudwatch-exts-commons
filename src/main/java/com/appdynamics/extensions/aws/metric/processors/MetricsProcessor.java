...
public interface MetricsProcessor {
    ...
    List<com.amazonaws.services.cloudwatch.model.Metric> filterUsingTags(List<com.amazonaws.services.cloudwatch.model.Metric> metrics, List<Tags> tags, String region);
}
